            ...
            <div className="row d-flex justify-content-center">
                <div className="col-lg-7">
                    <div className="blog__hero__text">
                        ...
                        <h2>Recent Recipe/Seasonal recipe</h2>
                        <ul>
                ...
                <div className="col-lg-8">
                    <div className="blog__details__content">
                        ...
                        <div className="blog__details__text">
                            <p>We begin our countdown with coffee cakes at number ten. 
This cake comes as a perfect dessert for coffee lovers. 
They are delicious and are available in multiple coffee flavours <br/>
                                For example, bake it on a Monday and freeze it, then take it out and decorate it on Friday..</p>
                            <p>Always good to have arecipe in mind .</p>
                        </div>
