                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="product__item">
                            ...
                            <div className="product__item__text">
                                <h6><a href="#"> LOW SUGAR RECIPE</a></h6>
